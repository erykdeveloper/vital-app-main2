...
import { ArrowLeft, Footprints, Clock, Flame, MapPin } from 'lucide-react';
...
export default function CardioRunning() {
  const { user } = useAuth();
  ...
  const { saveDraft, loadDraft, clearDraft } = useWorkoutDraft<RunningDraft>('corrida');
