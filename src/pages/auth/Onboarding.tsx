...
export default function Onboarding() {
  ...
  if (showGetStarted) {
    return (
      <div className="min-h-[100svh] overflow-y-auto bg-background text-foreground">
        <div className="mx-auto flex min-h-[100svh] w-full max-w-[430px] flex-col px-6 pb-8">
          <div className="relative -mx-6 h-[38svh] min-h-[260px] max-h-[340px] overflow-hidden bg-background">
          ...
          <main className="flex flex-1 flex-col pt-5 text-center">
            <div className="space-y-2">
              <div className="mx-auto mb-3 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-primary text-primary-foreground shadow-glow">
                <VitalHeartIcon className="h-9 w-9" />
              </div>
              <h1 className="text-3xl font-bold leading-tight tracking-normal min-[390px]:text-[2rem]">
            ...
            <p className="mt-auto pb-2 pt-8 text-base text-foreground">
              Já tem conta?{' '}
  ...
  return (
    <div className="min-h-[100svh] overflow-hidden bg-background text-white">
      <div className="relative mx-auto min-h-[100svh] w-full max-w-[430px] overflow-hidden">
        <div
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-background/5 via-background/65 to-background" />

        <div className="relative flex min-h-[100svh] flex-col px-6 pb-8 pt-10">
          ...
          <main className="mt-auto text-center">
            <div className="space-y-3">
              <h1 className="text-[2rem] font-bold leading-tight tracking-normal">{currentSlide.title}</h1>
              <p className="text-base leading-relaxed text-white/68">{currentSlide.description}</p>
            </div>
